...
import com.pabloazana.marvelsample.viewPresenters.baseView.presenters.NavigationdrawerPresenter;
import com.pabloazana.marvelsample.viewPresenters.startingView.views.StartingActivity;
import com.pabloazana.marvelsample.viewPresenters.utils.UiUtils;
...
public class NavigationDrawerFragment extends Fragment{
    ...
    private static final int NAVDRAWER_ITEM_MY_LIBRARY = 1;
    ...
    private static final int[] NAVDRAWER_TITLE_RES_ID = new int[]{
            ...
            R.string.navdrawer_item_my_library,
            R.string.navdrawer_item_settings
    };

    private static final int[] NAVDRAWER_ICON_RES_ID = new int[]{
            R.drawable.ic_nav_drawer_featured,
            R.drawable.ic_navdrawer_my_library,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new NavigationdrawerPresenter((StartingActivity)getActivity());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LinearLayout linearLayoutDrawer = (LinearLayout) inflater.inflate(getFragmentLayout(), container, false);
    ...
    public void initActionBarDrawerToggle(){
        actionBarDrawerToggle = new ActionBarDrawerToggle(getActivity(), drawerLayout, R.string.navigation_drawer_open, R.string.navigation_drawer_close){
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                if (!isAdded()) return;
                ((StartingActivity)getActivity()).supportInvalidateOptionsMenu();
            }
